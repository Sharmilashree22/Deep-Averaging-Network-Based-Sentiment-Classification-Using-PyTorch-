...
def get_args():
    ...
    parser.add_argument("--train", type=str, default="C:/Users/HP/Downloads/assignment1nlp/data/cfimdb-train.txt")
    parser.add_argument("--dev", type=str, default="C:/Users/HP/Downloads/assignment1nlp/data/cfimdb-dev.txt")
    parser.add_argument("--test", type=str, default="C:/Users/HP/Downloads/assignment1nlp/data/cfimdb-test.txt")
    parser.add_argument("--emb_file", type=str, default=None)
    parser.add_argument("--emb_size", type=int, default=300)
    parser.add_argument("--hid_size", type=int, default=700)
    ...
    parser.add_argument("--lrate", type=float, default=0.06)
    parser.add_argument("--lrate_decay", type=float, default=0)  
    parser.add_argument("--mrate", type=float, default=0.8)
    parser.add_argument("--log_niter", type=int, default=100)
    parser.add_argument("--eval_niter", type=int, default=500)
    parser.add_argument("--model", type=str, default="C:/Users/HP/Downloads/assignment1nlp/model.pt")  
    parser.add_argument("--dev_output", type=str, default="C:/Users/HP/Downloads/assignment1nlp/output.dev.txt")  
    parser.add_argument("--test_output", type=str, default="C:/Users/HP/Downloads/assignment1nlp/output.test.txt")
...
def pad_sentences(sents, pad_id):
    ...
    padded_sents = [sent + [pad_id] * (max_len - len(sent)) for sent in sents]
    return padded_sents
